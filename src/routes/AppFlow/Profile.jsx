            ...
            <div className="inline-flex flex-col items-start justify-start gap-1 grow shrink basis-0">
              ...
              <div class="self-stretch">
                <p className="self-stretch h-full">
                  ...
                  think it's a lifesaver-  1. tidies everything nice and
                  compact  2. makes responsive design effortless  3. no manual
                  adjustments post any tweaks 4. saves a tonnn of time  sorry,
                  but will stay an auto layout maxi all life.
                </p>
              </div>
              <div className="inline-flex items-center self-stretch justify-between">
                <div className="flex">
